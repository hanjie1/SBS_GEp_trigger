...
entity hcal_cluster_hls_all_fadc_hits_pre_pre_e_V_ram is 
    generic(
            DWIDTH     : integer := 13; 
            AWIDTH     : integer := 9; 
...
architecture rtl of hcal_cluster_hls_all_fadc_hits_pre_pre_e_V_ram is 
...
entity hcal_cluster_hls_all_fadc_hits_pre_pre_e_V is
    generic (
...
architecture arch of hcal_cluster_hls_all_fadc_hits_pre_pre_e_V is
    component hcal_cluster_hls_all_fadc_hits_pre_pre_e_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    hcal_cluster_hls_all_fadc_hits_pre_pre_e_V_ram_U :  component hcal_cluster_hls_all_fadc_hits_pre_pre_e_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
