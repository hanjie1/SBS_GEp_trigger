...
entity hcal_cluster_hls_allc_c_e_V_1_ram is 
    generic(
            DWIDTH     : integer := 16; 
            AWIDTH     : integer := 9; 
...
architecture rtl of hcal_cluster_hls_allc_c_e_V_1_ram is 
...
entity hcal_cluster_hls_allc_c_e_V_1 is
    generic (
...
architecture arch of hcal_cluster_hls_allc_c_e_V_1 is
    component hcal_cluster_hls_allc_c_e_V_1_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    hcal_cluster_hls_allc_c_e_V_1_ram_U :  component hcal_cluster_hls_allc_c_e_V_1_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
